...
namespace GroupBCapstoneProject.Controllers
{
    ...
    public class DataController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddCourse([Bind("ID,CourseNumber,SectionNumber,Capacity,Enrollment,FacultyID,StartTime,EndTime,BuildingName,BuildingNumber," +
